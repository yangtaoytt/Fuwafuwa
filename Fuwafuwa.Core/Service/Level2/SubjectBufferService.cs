...
public class
    ...
    IService<SubjectBufferService, NullSharedDataWrapper<object>, object, SubjectBufferService> {
    ...
    public static NullSharedDataWrapper<object>
        InitService(object initData, SubjectBufferService? uniqueService = null) {
        return new NullSharedDataWrapper<object>(initData);
    }

    protected override async Task ProcessData(NullServiceData serviceData, SubjectData subjectData,
