...
public class
    InitRegisterData<TService> : AProcessorData<InitRegisterData<TService>, bool, ServiceWithRegister<TService>>
    where TService : ServiceWithRegister<TService> {
...
/// <typeparam name="TService">The service with register.</typeparam>
public class
    RemoveRegisterData<TService> : AProcessorData<RemoveRegisterData<TService>, bool, ServiceWithRegister<TService>>
    where TService : ServiceWithRegister<TService> {
    public readonly string ServiceName;
